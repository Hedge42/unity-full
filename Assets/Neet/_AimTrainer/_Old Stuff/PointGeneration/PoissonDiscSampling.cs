...
public static class PoissonDiscSampling
{
    ...
    public static List<Vector2> GeneratePoints(float minRadius, float maxRadius,
        Vector2 sampleRegionSize, int numToGenerate = -1, 
        List<Vector2> startPoints = null, int numSamplesBeforeRejection = 30)
    {
