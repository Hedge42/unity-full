...
public class SettingsManager : MonoBehaviour
{
    ...
    public static string path { get { return FileManager.instance.SettingsPath + fileName; } }
    ...
    {
        string path = FileManager.instance.SerializeJson(setting, FileManager.instance.SettingsPath, fileName);
